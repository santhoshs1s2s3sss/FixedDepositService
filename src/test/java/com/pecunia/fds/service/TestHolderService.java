...
public class TestHolderService {
	/*
	 * @Autowired FixedDepositHoldersService fixedDepositService;
	 * 
	 * @Autowired FixedDepositsService fds;
	 * 
	 * 
	 * @Test public void testGetHolderById_Positive() throws Exception {
	 * Optional<FixedDepositHolders> holder =
	 * fixedDepositService.getFixedDepositHolders(2222);
	 * Assertions.assertEquals(true,holder.isPresent()); }
	 * 
	 * @Test public void testGetHolderById_Negative() throws Exception {
	 * Optional<FixedDepositHolders> holder =
	 * fixedDepositService.getFixedDepositHolders(2222);
